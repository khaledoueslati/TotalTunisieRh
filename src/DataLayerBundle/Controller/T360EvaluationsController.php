...
class T360EvaluationsController extends Controller
{
     ...
     * @Method("POST")
     * @Template("DataLayerBundle:T360Evaluations:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('t360evaluations_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    {
        $form = $this->createForm(new T360EvaluationsType(), $entity, array(
            'action' => $this->generateUrl('t360evaluations_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("DataLayerBundle:T360Evaluations:edit.html.twig")
     */
